...
pub mod fungible_token_wrapper_contract {
    ...
    impl ::ethers::core::abi::AbiDecode for FungibleTokenWrapperContractCalls {
        fn decode(
            ...
            if let Ok(decoded) = <GetTokensCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <HistoricalTokensCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <IsNativeAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetNativeAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <UpdateLimitCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <WrappingLimitCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
