...
pub mod verifier_2x_2_contract {
    ...
    pub static VERIFIER2X2CONTRACT_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static VERIFIER2X2CONTRACT_DEPLOYED_BYTECODE:
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for Verifier2x2Contract<M>
    {
