...
pub mod v_anchor_verifier_contract {
    ...
    pub static VANCHORVERIFIERCONTRACT_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static VANCHORVERIFIERCONTRACT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::core::abi::AbiDecode for VAnchorVerifierContractCalls {
        fn decode(
            ...
            if let Ok(decoded) = <V216Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::V216(decoded));
            }
            if let Ok(decoded) = <V22Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::V22(decoded));
            }
            if let Ok(decoded) = <V816Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::V816(decoded));
            }
            if let Ok(decoded) = <V82Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::V82(decoded));
            }
            if let Ok(decoded) = <VerifyProofCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for VAnchorVerifierContractCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::V216(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::V22(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::V816(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::V82(element) => ::ethers::core::abi::AbiEncode::encode(element),
