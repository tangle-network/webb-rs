...
pub mod v_anchor_encode_inputs_contract {
    ...
    pub static VANCHORENCODEINPUTSCONTRACT_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static VANCHORENCODEINPUTSCONTRACT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::core::abi::AbiDecode for VAnchorEncodeInputsContractCalls {
        fn decode(
            ...
            if let Ok(decoded) = <EncodeInputs16Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::EncodeInputs16(decoded));
            }
            if let Ok(decoded) = <EncodeInputs2Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::fmt::Display for VAnchorEncodeInputsContractCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::EncodeInputs16(element) => ::core::fmt::Display::fmt(element, f),
                Self::EncodeInputs2(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetChainId(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetChainIdType(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<EvmChainIdTypeCall> for VAnchorEncodeInputsContractCalls {
        fn from(value: EvmChainIdTypeCall) -> Self {
            Self::EvmChainIdType(value)
        }
    }
    impl ::core::convert::From<EncodeInputs16Call> for VAnchorEncodeInputsContractCalls {
        fn from(value: EncodeInputs16Call) -> Self {
            Self::EncodeInputs16(value)
        }
    }
    impl ::core::convert::From<EncodeInputs2Call> for VAnchorEncodeInputsContractCalls {
        fn from(value: EncodeInputs2Call) -> Self {
            Self::EncodeInputs2(value)
        }
    }
    impl ::core::convert::From<GetChainIdCall> for VAnchorEncodeInputsContractCalls {
        fn from(value: GetChainIdCall) -> Self {
            Self::GetChainId(value)
        }
    }
    impl ::core::convert::From<GetChainIdTypeCall> for VAnchorEncodeInputsContractCalls {
