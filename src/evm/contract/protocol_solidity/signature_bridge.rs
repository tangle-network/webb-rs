...
pub mod signature_bridge_contract {
    ...
    impl ::ethers::core::abi::AbiDecode for SignatureBridgeContractCalls {
        fn decode(
            ...
            if let Ok(decoded) = <CreateVoteCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <IsGovernorCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RefreshNonceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <VoterCountCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::VoterCount(decoded));
            }
            if let Ok(decoded) = <VoterMerkleRootCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
