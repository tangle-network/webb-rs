...
pub mod v_anchor_tree_contract {
    ...
    impl<M> ::core::fmt::Debug for VAnchorTreeContract<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(VAnchorTreeContract))
                .field(&self.address())
                .finish()
        }
    }
