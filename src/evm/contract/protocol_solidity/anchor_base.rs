pub use anchor_base_contract::*;
#[allow(clippy::too_many_arguments, non_camel_case_types)]
pub mod anchor_base_contract {
    ...
    impl<M: ethers::providers::Middleware> AnchorBaseContract<M> {
    ...
    impl ::std::fmt::Display for AnchorBaseContractEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                AnchorBaseContractEvents::InitializedFilter(element) => {
                    element.fmt(f)
                }
