...
mod fixeddepositanchorcontract_mod {
    ...
    impl<M: ethers::providers::Middleware> FixedDepositAnchorContract<M> {
    ...
    impl ethers::contract::EthLogDecode for FixedDepositAnchorContractEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(FixedDepositAnchorContractEvents::InitializedFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for FixedDepositAnchorContractEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                FixedDepositAnchorContractEvents::InitializedFilter(
                    element,
                ) => element.fmt(f),
