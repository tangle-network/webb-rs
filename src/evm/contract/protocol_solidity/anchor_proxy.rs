...
mod anchorproxycontract_mod {
    ...
    use std::sync::Arc;
    pub static ANCHORPROXYCONTRACT_ABI: ethers_contract::Lazy<
        ethers_core::abi::Abi,
    ...
    #[derive(Clone)]
    pub struct AnchorProxyContract<M>(ethers_contract::Contract<M>);
    ...
    impl<'a, M: ethers_providers::Middleware> AnchorProxyContract<M> {
        ...
        pub fn backup_notes(
            &self,
            encrypted_notes: ::std::vec::Vec<ethers_core::types::Bytes>,
        ...
        pub fn deposit(
            &self,
            anchor: ethers_core::types::Address,
            commitment: [u8; 32],
            encrypted_note: ethers_core::types::Bytes,
        ) -> ethers_contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash(
                    [19, 217, 141, 19],
        ...
        pub fn anchor_proxy_deposit_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, AnchorProxyDepositFilter>
        {
            self.0.event()
        }
        ...
        pub fn encrypted_note_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, EncryptedNoteFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `InstanceStateUpdated` event"]
        pub fn instance_state_updated_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, InstanceStateUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ethers_contract::builders::Event<M, AnchorProxyContractEvents>
        {
    ...
    pub struct AnchorProxyDepositFilter {
        #[ethevent(indexed)]
        pub anchor: ethers_core::types::Address,
        #[ethevent(indexed)]
    ...
    pub struct InstanceStateUpdatedFilter {
        #[ethevent(indexed)]
        pub instance: ethers_core::types::Address,
        pub state: u8,
    }
    ...
    impl ethers_contract::EthLogDecode for AnchorProxyContractEvents {
        fn decode_log(
    ...
    pub struct BackupNotesCall {
        pub encrypted_notes: ::std::vec::Vec<ethers_core::types::Bytes>,
    }
    ...
    pub struct InstancesCall(pub ethers_core::types::Address);
    ...
    impl ethers_core::abi::AbiDecode for AnchorProxyContractCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> Result<Self, ethers_core::abi::AbiError> {
            if let Ok(decoded) =
                <AnchorTreesCall as ethers_core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
            ...
            if let Ok(decoded) =
                <BackupNotesCall as ethers_core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
            ...
            if let Ok(decoded) =
                <GovernanceCall as ethers_core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
            ...
            if let Ok(decoded) =
                <InstancesCall as ethers_core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
    ...
    impl ethers_core::abi::AbiEncode for AnchorProxyContractCalls {
