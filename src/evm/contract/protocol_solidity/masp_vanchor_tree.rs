pub use multi_asset_v_anchor_tree::*;
...
pub mod multi_asset_v_anchor_tree {
    #[allow(deprecated)]
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function { name :
                        ::std::borrow::ToOwned::to_owned("currentRootIndex"), inputs :
                        ::std::vec![], outputs :
                        ::std::vec![::ethers::core::abi::ethabi::Param { name :
                        ::std::string::String::new(), kind :
                        ::ethers::core::abi::ethabi::ParamType::Uint(32usize),
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function { name :
                        ::std::borrow::ToOwned::to_owned("hasher"), inputs :
                        ::std::vec![], outputs :
                        ::std::vec![::ethers::core::abi::ethabi::Param { name :
                        ::std::string::String::new(), kind :
                        ::ethers::core::abi::ethabi::ParamType::Address, internal_type :
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function { name :
                        ::std::borrow::ToOwned::to_owned("levels"), inputs :
                        ::std::vec![], outputs :
                        ::std::vec![::ethers::core::abi::ethabi::Param { name :
                        ::std::string::String::new(), kind :
                        ::ethers::core::abi::ethabi::ParamType::Uint(32usize),
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function { name :
                        ::std::borrow::ToOwned::to_owned("nextIndex"), inputs :
                        ::std::vec![], outputs :
                        ::std::vec![::ethers::core::abi::ethabi::Param { name :
                        ::std::string::String::new(), kind :
                        ::ethers::core::abi::ethabi::ParamType::Uint(32usize),
    ...
    pub static MULTIASSETVANCHORTREE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct MultiAssetVAnchorTree<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MultiAssetVAnchorTree<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MultiAssetVAnchorTree<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MultiAssetVAnchorTree<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MultiAssetVAnchorTree<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(MultiAssetVAnchorTree))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> MultiAssetVAnchorTree<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    MULTIASSETVANCHORTREE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            MultiAssetVAnchorTreeEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for MultiAssetVAnchorTree<M> {
    ...
    pub enum MultiAssetVAnchorTreeEvents {
    ...
    impl ::ethers::contract::EthLogDecode for MultiAssetVAnchorTreeEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = EdgeAdditionFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::EdgeAdditionFilter(decoded));
            }
            if let Ok(decoded) = EdgeUpdateFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::EdgeUpdateFilter(decoded));
            }
            if let Ok(decoded) = InsertionFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::InsertionFilter(decoded));
            }
            if let Ok(decoded) = MaxDepositLimitUpdatedFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeEvents::MaxDepositLimitUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = MinWithdrawalLimitUpdatedFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeEvents::MinWithdrawalLimitUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = NewCommitmentFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::NewCommitmentFilter(decoded));
            }
            if let Ok(decoded) = NewNullifierFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::NewNullifierFilter(decoded));
            }
            if let Ok(decoded) = PublicKeyFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::PublicKeyFilter(decoded));
            }
            if let Ok(decoded) = SetHandlerFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::SetHandlerFilter(decoded));
            }
            if let Ok(decoded) = SetVerifierFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeEvents::SetVerifierFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for MultiAssetVAnchorTreeEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<EdgeAdditionFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: EdgeAdditionFilter) -> Self {
            Self::EdgeAdditionFilter(value)
        }
    }
    impl ::core::convert::From<EdgeUpdateFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: EdgeUpdateFilter) -> Self {
            Self::EdgeUpdateFilter(value)
        }
    }
    impl ::core::convert::From<InsertionFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: InsertionFilter) -> Self {
            Self::InsertionFilter(value)
        }
    }
    impl ::core::convert::From<MaxDepositLimitUpdatedFilter>
    for MultiAssetVAnchorTreeEvents {
    ...
    impl ::core::convert::From<NewCommitmentFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: NewCommitmentFilter) -> Self {
            Self::NewCommitmentFilter(value)
        }
    }
    impl ::core::convert::From<NewNullifierFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: NewNullifierFilter) -> Self {
            Self::NewNullifierFilter(value)
        }
    }
    impl ::core::convert::From<PublicKeyFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: PublicKeyFilter) -> Self {
            Self::PublicKeyFilter(value)
        }
    }
    impl ::core::convert::From<SetHandlerFilter> for MultiAssetVAnchorTreeEvents {
        fn from(value: SetHandlerFilter) -> Self {
            Self::SetHandlerFilter(value)
        }
    }
    impl ::core::convert::From<SetVerifierFilter> for MultiAssetVAnchorTreeEvents {
    ...
    pub enum MultiAssetVAnchorTreeCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for MultiAssetVAnchorTreeCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <RegisterAndTransactCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::fmt::Display for MultiAssetVAnchorTreeCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<EvmChainIdTypeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: EvmChainIdTypeCall) -> Self {
            Self::EvmChainIdType(value)
        }
    }
    impl ::core::convert::From<FieldSizeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: FieldSizeCall) -> Self {
            Self::FieldSize(value)
        }
    }
    impl ::core::convert::From<MaxExtAmountCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: MaxExtAmountCall) -> Self {
            Self::MaxExtAmount(value)
        }
    }
    impl ::core::convert::From<MaxFeeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: MaxFeeCall) -> Self {
            Self::MaxFee(value)
        }
    }
    impl ::core::convert::From<RootHistorySizeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: RootHistorySizeCall) -> Self {
            Self::RootHistorySize(value)
        }
    }
    impl ::core::convert::From<UpdateMaxLengthCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: UpdateMaxLengthCall) -> Self {
            Self::UpdateMaxLength(value)
        }
    }
    impl ::core::convert::From<ZeroValueCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: ZeroValueCall) -> Self {
            Self::ZeroValue(value)
        }
    }
    impl ::core::convert::From<GenExtDataHashCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GenExtDataHashCall) -> Self {
            Self::GenExtDataHash(value)
        }
    }
    impl ::core::convert::From<CalculatePublicAmountCall>
    for MultiAssetVAnchorTreeCalls {
        fn from(value: CalculatePublicAmountCall) -> Self {
            Self::CalculatePublicAmount(value)
        }
    }
    impl ::core::convert::From<CommitmentsCall> for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::convert::From<CurrentRootIndexCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: CurrentRootIndexCall) -> Self {
            Self::CurrentRootIndex(value)
        }
    }
    impl ::core::convert::From<EdgeExistsForChainCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: EdgeExistsForChainCall) -> Self {
            Self::EdgeExistsForChain(value)
        }
    }
    impl ::core::convert::From<EdgeIndexCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: EdgeIndexCall) -> Self {
            Self::EdgeIndex(value)
        }
    }
    impl ::core::convert::From<EdgeListCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: EdgeListCall) -> Self {
            Self::EdgeList(value)
        }
    }
    impl ::core::convert::From<FilledSubtreesCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: FilledSubtreesCall) -> Self {
            Self::FilledSubtrees(value)
        }
    }
    impl ::core::convert::From<GetChainIdCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetChainIdCall) -> Self {
            Self::GetChainId(value)
        }
    }
    impl ::core::convert::From<GetChainIdTypeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetChainIdTypeCall) -> Self {
            Self::GetChainIdType(value)
        }
    }
    impl ::core::convert::From<GetHasherCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetHasherCall) -> Self {
            Self::GetHasher(value)
        }
    }
    impl ::core::convert::From<GetLastRootCall> for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::convert::From<GetLevelsCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetLevelsCall) -> Self {
            Self::GetLevels(value)
        }
    }
    impl ::core::convert::From<GetNextIndexCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetNextIndexCall) -> Self {
            Self::GetNextIndex(value)
        }
    }
    impl ::core::convert::From<GetZeroHashCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: GetZeroHashCall) -> Self {
            Self::GetZeroHash(value)
        }
    }
    impl ::core::convert::From<HandlerCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: HandlerCall) -> Self {
            Self::Handler(value)
        }
    }
    impl ::core::convert::From<HasEdgeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: HasEdgeCall) -> Self {
            Self::HasEdge(value)
        }
    }
    impl ::core::convert::From<HashLeftRightCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: HashLeftRightCall) -> Self {
            Self::HashLeftRight(value)
        }
    }
    impl ::core::convert::From<HasherCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: HasherCall) -> Self {
            Self::Hasher(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<InitializedCall> for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::convert::From<IsKnownNeighborRootCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: IsKnownNeighborRootCall) -> Self {
            Self::IsKnownNeighborRoot(value)
        }
    }
    impl ::core::convert::From<IsKnownRootCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: IsKnownRootCall) -> Self {
            Self::IsKnownRoot(value)
        }
    }
    impl ::core::convert::From<IsSpentCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: IsSpentCall) -> Self {
            Self::IsSpent(value)
        }
    }
    impl ::core::convert::From<IsSpentArrayCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: IsSpentArrayCall) -> Self {
            Self::IsSpentArray(value)
        }
    }
    impl ::core::convert::From<IsValidRootsCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: IsValidRootsCall) -> Self {
            Self::IsValidRoots(value)
        }
    }
    impl ::core::convert::From<LastBalanceCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: LastBalanceCall) -> Self {
            Self::LastBalance(value)
        }
    }
    impl ::core::convert::From<LevelsCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: LevelsCall) -> Self {
            Self::Levels(value)
        }
    }
    impl ::core::convert::From<MaxEdgesCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: MaxEdgesCall) -> Self {
            Self::MaxEdges(value)
        }
    }
    impl ::core::convert::From<MaximumDepositAmountCall> for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::convert::From<NeighborRootsCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: NeighborRootsCall) -> Self {
            Self::NeighborRoots(value)
        }
    }
    impl ::core::convert::From<NextIndexCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: NextIndexCall) -> Self {
            Self::NextIndex(value)
        }
    }
    impl ::core::convert::From<NullifierHashesCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: NullifierHashesCall) -> Self {
            Self::NullifierHashes(value)
        }
    }
    impl ::core::convert::From<OnERC721ReceivedCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<OuterLevelsCall> for MultiAssetVAnchorTreeCalls {
    ...
    impl ::core::convert::From<ProposalNonceCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: ProposalNonceCall) -> Self {
            Self::ProposalNonce(value)
        }
    }
    impl ::core::convert::From<RegisterCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: RegisterCall) -> Self {
            Self::Register(value)
        }
    }
    impl ::core::convert::From<RegisterAndTransactCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: RegisterAndTransactCall) -> Self {
            Self::RegisterAndTransact(value)
        }
    }
    impl ::core::convert::From<RegistryCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: RegistryCall) -> Self {
            Self::Registry(value)
        }
    }
    impl ::core::convert::From<RootsCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: RootsCall) -> Self {
            Self::Roots(value)
        }
    }
    impl ::core::convert::From<SetHandlerCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: SetHandlerCall) -> Self {
            Self::SetHandler(value)
        }
    }
    impl ::core::convert::From<SetVerifierCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: SetVerifierCall) -> Self {
            Self::SetVerifier(value)
        }
    }
    impl ::core::convert::From<SwapCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: SwapCall) -> Self {
            Self::Swap(value)
        }
    }
    impl ::core::convert::From<TransactCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: TransactCall) -> Self {
            Self::Transact(value)
        }
    }
    impl ::core::convert::From<UnpackProofCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: UnpackProofCall) -> Self {
            Self::UnpackProof(value)
        }
    }
    impl ::core::convert::From<UpdateEdgeCall> for MultiAssetVAnchorTreeCalls {
        fn from(value: UpdateEdgeCall) -> Self {
            Self::UpdateEdge(value)
        }
    }
    impl ::core::convert::From<VerifierCall> for MultiAssetVAnchorTreeCalls {
