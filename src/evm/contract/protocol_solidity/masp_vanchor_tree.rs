pub use multi_asset_v_anchor_tree_contract::*;
...
pub mod multi_asset_v_anchor_tree_contract {
    #[allow(deprecated)]
    ...
    pub static MULTIASSETVANCHORTREECONTRACT_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct MultiAssetVAnchorTreeContract<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MultiAssetVAnchorTreeContract<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MultiAssetVAnchorTreeContract<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MultiAssetVAnchorTreeContract<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MultiAssetVAnchorTreeContract<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(MultiAssetVAnchorTreeContract))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> MultiAssetVAnchorTreeContract<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    MULTIASSETVANCHORTREECONTRACT_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            MultiAssetVAnchorTreeContractEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for MultiAssetVAnchorTreeContract<M> {
    ...
    pub enum MultiAssetVAnchorTreeContractEvents {
    ...
    impl ::ethers::contract::EthLogDecode for MultiAssetVAnchorTreeContractEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = EdgeAdditionFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::EdgeAdditionFilter(decoded),
                );
            }
            if let Ok(decoded) = EdgeUpdateFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::EdgeUpdateFilter(decoded),
                );
            }
            if let Ok(decoded) = InsertionFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeContractEvents::InsertionFilter(decoded));
            }
            if let Ok(decoded) = MaxDepositLimitUpdatedFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::MaxDepositLimitUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = MinWithdrawalLimitUpdatedFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::MinWithdrawalLimitUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = NewCommitmentFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::NewCommitmentFilter(decoded),
                );
            }
            if let Ok(decoded) = NewNullifierFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::NewNullifierFilter(decoded),
                );
            }
            if let Ok(decoded) = PublicKeyFilter::decode_log(log) {
                return Ok(MultiAssetVAnchorTreeContractEvents::PublicKeyFilter(decoded));
            }
            if let Ok(decoded) = SetHandlerFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::SetHandlerFilter(decoded),
                );
            }
            if let Ok(decoded) = SetVerifierFilter::decode_log(log) {
                return Ok(
                    MultiAssetVAnchorTreeContractEvents::SetVerifierFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for MultiAssetVAnchorTreeContractEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for MultiAssetVAnchorTreeContractEvents {
    ...
    impl ::core::convert::From<InsertionFilter> for MultiAssetVAnchorTreeContractEvents {
    ...
    impl ::core::convert::From<PublicKeyFilter> for MultiAssetVAnchorTreeContractEvents {
    ...
    pub enum MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for MultiAssetVAnchorTreeContractCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::fmt::Display for MultiAssetVAnchorTreeContractCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for MultiAssetVAnchorTreeContractCalls {
        fn from(value: EvmChainIdTypeCall) -> Self {
            Self::EvmChainIdType(value)
        }
    }
    impl ::core::convert::From<FieldSizeCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: FieldSizeCall) -> Self {
            Self::FieldSize(value)
        }
    }
    impl ::core::convert::From<MaxExtAmountCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: MaxExtAmountCall) -> Self {
            Self::MaxExtAmount(value)
        }
    }
    impl ::core::convert::From<MaxFeeCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<ZeroValueCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<CommitmentsCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<EdgeIndexCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: EdgeIndexCall) -> Self {
            Self::EdgeIndex(value)
        }
    }
    impl ::core::convert::From<EdgeListCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<GetChainIdCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<GetHasherCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: GetHasherCall) -> Self {
            Self::GetHasher(value)
        }
    }
    impl ::core::convert::From<GetLastRootCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<GetLevelsCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: GetLevelsCall) -> Self {
            Self::GetLevels(value)
        }
    }
    impl ::core::convert::From<GetNextIndexCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: GetNextIndexCall) -> Self {
            Self::GetNextIndex(value)
        }
    }
    impl ::core::convert::From<GetZeroHashCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: GetZeroHashCall) -> Self {
            Self::GetZeroHash(value)
        }
    }
    impl ::core::convert::From<HandlerCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: HandlerCall) -> Self {
            Self::Handler(value)
        }
    }
    impl ::core::convert::From<HasEdgeCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<HasherCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: HasherCall) -> Self {
            Self::Hasher(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<InitializedCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<IsKnownRootCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: IsKnownRootCall) -> Self {
            Self::IsKnownRoot(value)
        }
    }
    impl ::core::convert::From<IsSpentCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: IsSpentCall) -> Self {
            Self::IsSpent(value)
        }
    }
    impl ::core::convert::From<IsSpentArrayCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: IsSpentArrayCall) -> Self {
            Self::IsSpentArray(value)
        }
    }
    impl ::core::convert::From<IsValidRootsCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: IsValidRootsCall) -> Self {
            Self::IsValidRoots(value)
        }
    }
    impl ::core::convert::From<LastBalanceCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: LastBalanceCall) -> Self {
            Self::LastBalance(value)
        }
    }
    impl ::core::convert::From<LevelsCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: LevelsCall) -> Self {
            Self::Levels(value)
        }
    }
    impl ::core::convert::From<MaxEdgesCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<NextIndexCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<OuterLevelsCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<RegisterCall> for MultiAssetVAnchorTreeContractCalls {
    ...
    impl ::core::convert::From<RegistryCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: RegistryCall) -> Self {
            Self::Registry(value)
        }
    }
    impl ::core::convert::From<RootsCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: RootsCall) -> Self {
            Self::Roots(value)
        }
    }
    impl ::core::convert::From<SetHandlerCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: SetHandlerCall) -> Self {
            Self::SetHandler(value)
        }
    }
    impl ::core::convert::From<SetVerifierCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: SetVerifierCall) -> Self {
            Self::SetVerifier(value)
        }
    }
    impl ::core::convert::From<SwapCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: SwapCall) -> Self {
            Self::Swap(value)
        }
    }
    impl ::core::convert::From<TransactCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: TransactCall) -> Self {
            Self::Transact(value)
        }
    }
    impl ::core::convert::From<UnpackProofCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: UnpackProofCall) -> Self {
            Self::UnpackProof(value)
        }
    }
    impl ::core::convert::From<UpdateEdgeCall> for MultiAssetVAnchorTreeContractCalls {
        fn from(value: UpdateEdgeCall) -> Self {
            Self::UpdateEdge(value)
        }
    }
    impl ::core::convert::From<VerifierCall> for MultiAssetVAnchorTreeContractCalls {
