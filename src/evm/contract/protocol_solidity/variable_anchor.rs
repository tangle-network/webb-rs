...
mod vanchorcontract_mod {
    ...
    impl ethers::core::abi::AbiDecode for VAnchorContractCalls {
        fn decode(
            ...
            {
                return Ok(VAnchorContractCalls::WrapAndDeposit(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for VAnchorContractCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                VAnchorContractCalls::WrapAndDeposit(element) => {
                    element.encode()
                }
    ...
    impl ::std::fmt::Display for VAnchorContractCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                VAnchorContractCalls::WrapAndDeposit(element) => element.fmt(f),
    ...
    impl ::std::convert::From<WrapAndDepositCall> for VAnchorContractCalls {
        fn from(var: WrapAndDepositCall) -> Self {
            VAnchorContractCalls::WrapAndDeposit(var)
        }
    }
