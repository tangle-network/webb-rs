...
pub mod v_anchor_contract {
    ...
    impl<M> ::core::fmt::Debug for VAnchorContract<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(VAnchorContract)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::EthLogDecode for VAnchorContractEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = SetHandlerFilter::decode_log(log) {
                return Ok(VAnchorContractEvents::SetHandlerFilter(decoded));
            }
            if let Ok(decoded) = SetVerifierFilter::decode_log(log) {
                return Ok(VAnchorContractEvents::SetVerifierFilter(decoded));
            }
    ...
    impl ::core::convert::From<SetHandlerFilter> for VAnchorContractEvents {
        fn from(value: SetHandlerFilter) -> Self {
            Self::SetHandlerFilter(value)
        }
    }
    impl ::core::convert::From<SetVerifierFilter> for VAnchorContractEvents {
